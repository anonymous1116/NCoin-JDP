...
python training_SA3.py --experiment "SA3" --task $TASK --layer_len $layer_len --num_training 100000 --N_EPOCHS $N_EPOCHS --priors "P0"
python training_SA3.py --experiment "SA3" --task $TASK --layer_len $layer_len --num_training 100000 --N_EPOCHS $N_EPOCHS --priors "P1"
python training_SA3.py --experiment "SA3" --task $TASK --layer_len $layer_len --num_training 100000 --N_EPOCHS $N_EPOCHS --priors "P2"
python training_SA3.py --experiment "SA3" --task $TASK --layer_len $layer_len --num_training 100000 --N_EPOCHS $N_EPOCHS --priors "P3"
python training_SA3.py --experiment "SA3" --task $TASK --layer_len $layer_len --num_training 100000 --N_EPOCHS $N_EPOCHS --priors "P4"
