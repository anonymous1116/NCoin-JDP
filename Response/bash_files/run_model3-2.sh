...
python training_SA6_local.py --experiment "SA6_local" --task $TASK --layer_len $layer_len --num_training $num_training --N_EPOCHS $N_EPOCHS --tol $tol --x0_ind 0
python training_SA6_local.py --experiment "SA6_local" --task $TASK --layer_len $layer_len --num_training 4000000 --N_EPOCHS $N_EPOCHS --tol 0.5 --x0_ind 0
